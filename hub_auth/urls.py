...
urlpatterns = [
    ...
    path(api_version_prefix + 'accounts/', include('accounts.urls.account_urls')),
    ...
    path(api_version_prefix + 'dashboard/reports/', include('dashboard.urls.report_urls')),
    ...
    path(api_version_prefix + 'hub-closure/', include('hub_closure.urls')),
]